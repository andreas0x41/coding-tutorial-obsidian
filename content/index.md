...
These notes also include a few additional informations that are not directly exam relevant, more advanced or rarely used. On the page its self, you will find a Todo Info box before topics that are not exam relevant or only relevant for a specific department. Inside you sometimes also have details for whom/what this is topic is relevant. Here is an example.
