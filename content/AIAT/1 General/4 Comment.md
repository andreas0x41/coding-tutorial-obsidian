...
Docstrings are often used to document the definition of a [[AIAT/2 Control Flow/5 Function|function]], method, or class. You can put an explanation of what the function is doing, its parameters, return values, ... directly under the def/class keyword. Most IDEs will even display this explanation to the programmer when using the function/method/class.
...
[[AIAT/1 General/_assets/4 Comments/FunctionDocstringExample.jpg|Open: FunctionDocstringExample.jpg]]
![[AIAT/1 General/_assets/4 Comments/FunctionDocstringExample.jpg]]
