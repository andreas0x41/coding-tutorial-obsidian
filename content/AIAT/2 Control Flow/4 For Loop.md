...
A `for` loop is used to iterate over a [[AIAT/1 General/5 Datatype#Collection Datatypes|collection of elements]] or a [[AIAT/1 General/5 Datatype#Range|range]] of numbers.  

# Summary
- **Basic Usage**: Iterates over all elements in a [[AIAT/1 General/5 Datatype#Collection Datatypes|collection]] or [[AIAT/1 General/5 Datatype#Range|range]] automatically.
...
The [[AIAT/1 General/8 Keyword|keyword]] `break` works exactly the same as with a [[AIAT/2 Control Flow/3 While Loop#Break|while loop]] and is used to immediately exit the loop.
...
The [[AIAT/1 General/8 Keyword|keyword]] `continue` works exactly the same as with a [[AIAT/2 Control Flow/3 While Loop#Break|while loop]] and is used to skip the rest of the current iteration and move to the next one.
...
A `for` loop can have an `else` block, which works the same as with a [[AIAT/2 Control Flow/3 While Loop#Break|while loop]]. It runs only if the loop finishes normally (without `break`).
