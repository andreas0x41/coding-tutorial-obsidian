...
Selection allows the program to make decisions. The program chooses what code to execute next based on a condition. The basis for the decisions is **[[content/Theory Exam/2 Control Flow/2 Conditions|if]]** a [[content/Theory Exam/1 General/5 Datatype#Boolean|boolean]] is `True`, or whether a pattern matches.
...
This allows you to repeat a block of code multiple times. The block is repeatedly executed **[[content/Theory Exam/2 Control Flow/3 While Loop|while]]** a [[content/Theory Exam/1 General/5 Datatype#Boolean|boolean]] condition is true or **[[content/Theory Exam/2 Control Flow/4 For Loop|for]]** a fixed number of iterations. 
