...
A datatype defines how different types of information/data are stored and behave. Examples of the behavior can be found on the pages [[content/Theory Exam/Temp/1 General/7 Operator|Operators]], [[content/Python/2 Control Flow/6 Built-in Functions & Methods|Built-in Functions & Methods]], ...
...
## Truthy and Falsy
In Python, any value can be evaluated (e.g. in a [[content/Theory Exam/Temp/1 General/7 Operator#Logical Operators|logical operator]], [[content/Python/2 Control Flow/2 Conditions|condition]], ...) like a boolean. Python will treat it as truthy (`True`) or falsy (`False`) based on its type and value.
