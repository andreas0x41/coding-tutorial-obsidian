...
A `for` loop is used to iterate over a [[content/Python/1 General/5 Datatype#Collection Datatypes|collection of elements]] or a [[content/Python/1 General/5 Datatype#Range|range]] of numbers.  

# Summary
- **Basic Usage**: Iterates over all elements in a [[content/Python/1 General/5 Datatype#Collection Datatypes|collection]] or [[content/Python/1 General/5 Datatype#Range|range]] automatically.
...
The [[content/Python/1 General/8 Keyword|keyword]] `break` works exactly the same as with a [[content/Theory Exam/Temp/2 Control Flow/3 While Loop#Break|while loop]] and is used to immediately exit the loop.
...
The [[content/Python/1 General/8 Keyword|keyword]] `continue` works exactly the same as with a [[content/Theory Exam/Temp/2 Control Flow/3 While Loop#Break|while loop]] and is used to skip the rest of the current iteration and move to the next one.
