...
You can output to the console with the [[content/Theory Exam/2 Control Flow/5 Function|function]] `print()`. You can give `print()` any values of any [[content/Theory Exam/1 General/5 Datatype|datatype]] as [[content/Theory Exam/2 Control Flow/5 Function#Parameters|arguments]] and it will print it to the console.

## Hello World

In this example, we give the `print()` function the [[content/Theory Exam/1 General/5 Datatype#String|string]] "Hello World". This text will be outputted to the console.
...
You can also print any other values of any [[content/Theory Exam/1 General/5 Datatype|datatype]] using this function.
...
By default, after every printed value, there will be a [[content/Theory Exam/1 General/5 Datatype#Special Characters|line break]]. So the next value will be at the start of a new line. The code above will output the following text to the console. You can see that each output is in its own line.
...
If call the print function without any arguments, it will only output the [[content/Theory Exam/1 General/5 Datatype#Special Characters|newline]].
