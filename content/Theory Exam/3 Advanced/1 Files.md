...
# Open
To work with a file you first have to open it. The [[content/Theory Exam/2 Control Flow/5 Function|function]] `open(filePath, mode="rt")` opens the file located at `filePath` and returns it as a file object for further usage. 
