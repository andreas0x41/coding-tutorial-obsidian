...
- **Subroutines**: [[5 Function|Functions]] encapsulate reusable code, called with arguments and return values.
...
This allows you to repeat a block of code multiple times. The block is repeatedly executed **[[3 While Loop|while]]** a [[5 Datatype#Boolean|boolean]] condition is true or **[[4 For Loop|for]]** a fixed number of iterations. 
...
# Jumps
Jumps allow the program to exit the normal flow of execution and skip part of the code or go to a completely different position. Python allows you to exit a loop using **[[3 While Loop#Break|break]]** or go to the next iteration of a loop using **[[3 While Loop#Continue|continue]]**.
