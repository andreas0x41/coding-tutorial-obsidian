...
| -------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[5 Datatype#Boolean\|Datatype]]             | `False`    | Boolean value representing False.                                                                                                                           |
...
| [[6 Variable#Deleting\|Variable]]            | `del`      | Delete an object, variable, or items from a collection.                                                                                                   |
| [[5 Function#Scope\|Variable]]               | `global`   | Declares a variable as global, accessible outside the current scope.                                                                                        |
| [[5 Function#Scope\|Variable]]               | `nonlocal` | Refers to a variable in the nearest enclosing scope (not global).                                                                                           |
| [[2 Conditionals\|Flow Control]]             | `if`       | Defines a conditional statement.                                                                                                                            |
| [[2 Conditionals\|Flow Control]]             | `elif`     | Conditional branching; short for "else if".                                                                                                                 |
| [[2 Conditionals\|Flow Control]]             | `else`     | Defines the block of code to execute if the `if` condition is False. Also has a special use-case in the context of [[3 While Loop\|while]], for and except. |
...
| [[3 While Loop\|Flow Control]]               | `while`    | Defines a loop that continues as long as the condition is True.                                                                                             |
| [[4 For Loop\|Flow Control]]                 | `for`      | Defines a loop that iterates over a sequence.                                                                                                               |
| [[3 While Loop#Break\|Flow Control]]         | `break`    | Terminates/jumps after the nearest enclosing loop.                                                                                                          |
| [[3 While Loop#Continue\|Flow Control]]      | `continue` | Skips the remaining code in a loop iteration and moves to the next iteration.                                                                               |
| Flow Control                                 | `pass`     | Placeholder statement that does nothing.                                                                                                                    |
| [[5 Function#Basic\|Function]]               | `def`      | Defines a new function or method.                                                                                                                           |
| Function                                     | `lambda`   | Defines an anonymous/inline function.                                                                                                                       |
| [[5 Function#Basic\|Function]]               | `return`   | Exits a function and optionally passes back a value.                                                                                                        |
