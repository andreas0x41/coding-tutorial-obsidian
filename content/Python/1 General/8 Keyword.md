...
| [[2 Conditions\|Flow Control]]             | `if`       | Defines a conditional statement.                                                                                                                            |
| [[2 Conditions\|Flow Control]]             | `elif`     | Conditional branching; short for "else if".                                                                                                                 |
| [[2 Conditions\|Flow Control]]             | `else`     | Defines the block of code to execute if the `if` condition is False. Also has a special use-case in the context of [[3 While Loop\|while]], for and except. |
